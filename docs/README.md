...
This directory keeps operational notes that are too detailed for the root README.

Read `docs/tasks.md` first when resuming work in this repo. It records the current focus, open items when any exist, and validation notes.
